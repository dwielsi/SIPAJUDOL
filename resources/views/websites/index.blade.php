<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="truncate font-heading text-base font-semibold text-slate-900 dark:text-white">Master Website</h1>
                <p class="text-xs text-slate-400">Daftar website OPD yang dipantau</p>
            </div>
        </div>
    </x-slot>
