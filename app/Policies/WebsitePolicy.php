...
class WebsitePolicy
{
    ...
    {
        return $user->can('websites.viewAny');
    }
    ...
    {
        return $user->can('websites.create');
    }
    ...
    {
        return $user->can('websites.restore');
    }
    ...
    {
        return $user->can('websites.forceDelete');
    }
}
